...
import useFetchCollection from "../collection/useFetchCollection";
import useFetchCollections from "../collections/useFetchCollections";
import { Collection, Collections, Contract } from "../../types/types";

export default function DiscoverNfts(): React.JSX.Element {
  const { nfts, status, error } = useFetchCollection("big-hugs" || "");
  ...
  const visibleCollection = nfts.slice(0, 3);
